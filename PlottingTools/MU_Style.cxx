...
void drawLabels(bool isFiducial){
  ...
  lumi.DrawLatex( Xval,0.76,/*"#sqrt{s} =*/ "13 TeV, 79.8 fb^{-1}" );
...
void AdjustXaxis(TH1F* h, std::string var){
  ...
  if(var=="pt"){
    ...
    h->GetXaxis()->ChangeLabel(11,-1,-1,-1,-1,-1,"350");
