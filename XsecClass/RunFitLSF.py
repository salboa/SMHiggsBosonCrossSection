	...
	directory="../LSFjobs"
        ...
        if fixSys:
            ...
            for s in Sys:
                ...
                #os.system(cmdSys)
		what = v+s+".sh"
	        f = open(directory+"/"+what,'w')
		f.write("#!/bin/bash \n")
		#f.write("#BSUB -o %J.out\n")
		#f.write("#BSUB -e %J.err\n")
		#f.write("#BSUB -q 8nh\n")
		f.write("cd "+os.getcwd()+"\n")
		f.write("source /afs/cern.ch/user/a/angabrie/Work/public/root6bis/bin/setup.sh \n")
		f.write(os.getcwd()+"/"+cmdSys+"\n")
 		print "Submitting job: "+what
	        os.system("chmod +x ../LSFjobs/*")
	        os.system("sleep 2")
		os.system("bsub -q 8nh  "+os.getcwd()+"/"+directory+"/"+what)
